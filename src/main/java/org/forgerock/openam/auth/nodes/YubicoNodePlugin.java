 ...
 */
public class YubicoNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public YubicoNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
    ...
    protected Iterable<? extends Class<? extends Node>> getNodes() {
        return asList(
                YubicoPresenceNode.class,
                YubicoRegisterNode.class,
                YubicoValidateNode.class
        );
    }
}
